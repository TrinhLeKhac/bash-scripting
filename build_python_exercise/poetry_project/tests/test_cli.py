"""
Tests for poetry_demo CLI module
"""
...
from poetry_demo.cli import main
...
def test_cli_verbose():
    ...
    assert result.exit_code == 0
    assert "Hello, Test!" in result.output
    assert f"Poetry Demo v{__version__}" in result.output
...
def test_cli_help():
    ...
    assert result.exit_code == 0
    assert "Poetry Demo CLI" in result.output
