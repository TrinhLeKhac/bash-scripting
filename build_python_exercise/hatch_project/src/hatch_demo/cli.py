#!/usr/bin/env python3
"""
CLI module for hatch-demo package
"""
...
from hatch_demo.__about__ import __version__
...
def main(name: str, url: Optional[str], verbose: bool):
    """Hatch Demo CLI - Modern Python packaging demonstration"""
    ...
    if config.verbose:
        click.echo(f"Hatch Demo v{__version__}")
        click.echo(f"Configuration: {config.model_dump()}")
